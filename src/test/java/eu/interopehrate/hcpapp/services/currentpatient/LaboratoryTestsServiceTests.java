...
@SpringBootTest
public class LaboratoryTestsServiceTests {
    ...
    public static void init() throws IOException {
        ClassLoader classLoader = LaboratoryTestsServiceTests.class.getClassLoader();
    ...
    @Test
    public void testLaboratoryTestsSection() {
    ...
    @Test
    public void testLaboratoryTestsCode() {
        Bundle patientSummaryBundle = (Bundle) FhirContext.forR4().newJsonParser().parseResource(initialJsonFhir);
        currentPatient.initLaboratoryResults(patientSummaryBundle);
