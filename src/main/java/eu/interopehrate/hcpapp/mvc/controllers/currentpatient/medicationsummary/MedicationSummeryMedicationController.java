...
public class MedicationSummeryMedicationController {
    ...
    public MedicationSummeryMedicationController(MedicationSummaryService medicationSummaryService) {
    ...
    public String viewSection(Model model) {
        model.addAttribute("medicationCommand", medicationSummaryService.medicationCommand());
