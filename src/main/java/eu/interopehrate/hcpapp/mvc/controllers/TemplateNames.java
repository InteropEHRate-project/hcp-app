...
public interface TemplateNames {
    ...
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_RADIOLOGY_RESULTS_DEVICE_VIEW = "current-patient/laboratory-tests/radiology-results/device-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_RADIOLOGY_RESULTS_IMAGING_STUDY_VIEW = "current-patient/laboratory-tests/radiology-results/imaging-study-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_RADIOLOGY_RESULTS_ORGANIZATION_VIEW = "current-patient/laboratory-tests/radiology-results/organization-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_RADIOLOGY_RESULTS_PRACTITIONER_VIEW = "current-patient/laboratory-tests/radiology-results/practitioner-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_PATHOLOGY_RESULTS_OBSERVATION_PATHOLOGY_VIEW = "current-patient/laboratory-tests/pathology-results/observation-laboratory-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_PATHOLOGY_RESULTS_SPECIMEN_VIEW = "current-patient/laboratory-tests/pathology-results/specimen-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_PATHOLOGY_RESULTS_ORGANISATION_LABORATORY_VIEW = "current-patient/laboratory-tests/pathology-results/organization-laboratory-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_PATHOLOGY_RESULTS_OBSERVATION_LABORATORY_MEDIA_VIEW = "current-patient/laboratory-tests/pathology-results/observation-laboratory-media-view";
    String CURRENT_PATIENT_DIAGNOSTIC_RESULT_OTHER_RESULTS_VIEW_SECTION = "current-patient/laboratory-tests/other-results/view-section";
