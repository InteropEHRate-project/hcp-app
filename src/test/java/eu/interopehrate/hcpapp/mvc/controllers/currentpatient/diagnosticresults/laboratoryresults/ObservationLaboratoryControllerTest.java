...
class ObservationLaboratoryControllerTest {
    ...
    void setUp() {
        ...
        ObservationLaboratoryService service = new ObservationLaboratoryServiceImpl(new CurrentPatient(new TranslateServiceImpl(new RestTemplate())));
    ...
    void viewSection() {
        ...
        verify(this.model, times(1)).addAttribute(eq("observationLaboratory"), any(ObservationLaboratoryCommand.class));
    }
}